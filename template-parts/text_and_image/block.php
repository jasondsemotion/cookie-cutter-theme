...
if($widths == 'thirty-seventy') {
    $width_one = 'medium-12 large-3';
    $width_two = 'medium-12 large-9';
}
if($widths == 'forty-sixty') {
    $width_one = 'medium-12 large-4';
    $width_two = 'medium-12 large-8';
}
if($widths == 'fifty-fifty') {
    $width_one = 'medium-12 large-6';
    $width_two = 'medium-12 large-6';
}
if($widths == 'sixty-forty') {
    $width_one = 'medium-12 large-8';
    $width_two = 'medium-12 large-4';
}
if($widths == 'seventy-thirty') {
    $width_one = 'medium-12 large-9';
    $width_two = 'medium-12 large-3';
}
?>
